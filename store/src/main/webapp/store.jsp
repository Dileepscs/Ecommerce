...
<body>
    <div class="container">
                ...
                <div class="nav-image">
                    <svg viewBox="0 0 127 16">
                        <path
                            ...
                            fill="#D5333E" fill-rule="evenodd" clip-rule="evenodd"></path>
                    </svg>
                </div>
                <div class="nav-right">
                    <ul class="nav-items">
                    ...
                    <button class="btn" id="cart">Cart</button>
                </div>
                <div class="nav-icon">
        ...
        <div class="sort-category">
            <select name="category" id="option1">
        ...
        <div class="introduction">
            <div class="intro-left">
                ...
                <p class="description">
                    Codigo comprises a team of brilliant minds and innovative individuals who create digital products
                    people love to use.
                </p>
                <p class="description">
        ...
        <footer class="footer">
            <h1 class="footer-main-heading">Let's have a chat</h1>
            <!-- <div class="footer-container">
                <div class="footer-container-zero footer-container-common">
                    <div class="footer-header">
                        <h2 class="footer-heading">Build</h2>
                        <svg width="13" height="9" viewBox="0 0 13 9" fill="none">
                            <path d="M12.5 4.74973L7.5 8.75L7.5 0.75L12.5 4.74973Z" fill="#D5333E"></path>
                            <path d="M10 4.75H0" stroke="#D5333E"></path>
                        </svg>
                    </div>
                    <p class="footer-description">Help you build something</p>
                </div>
                <div class="footer-container-one footer-container-common">
                    <div class="footer-header">
                        <h2 class="footer-heading">Co-incubate</h2>
                        <svg width="13" height="9" viewBox="0 0 13 9" fill="none">
                            <path d="M12.5 4.74973L7.5 8.75L7.5 0.75L12.5 4.74973Z" fill="#D5333E"></path>
                            <path d="M10 4.75H0" stroke="#D5333E"></path>
                        </svg>
                    </div>
                    <p class="footer-description">Co-incubate an idea together</p>
                </div>
                <div class="footer-container-two footer-container-common">
                    <div class="footer-header">
                        <h2 class="footer-heading">Customise</h2>
                        <svg width="13" height="9" viewBox="0 0 13 9" fill="none">
                            <path d="M12.5 4.74973L7.5 8.75L7.5 0.75L12.5 4.74973Z" fill="#D5333E"></path>
                            <path d="M10 4.75H0" stroke="#D5333E"></path>
                        </svg>
                    </div>
                    <p class="footer-description">Customise a solution for your business</p>
                </div>
                <div class="footer-container-three footer-container-common">
                    <div class="footer-header">
                        <h2 class="footer-heading">Organise</h2>
                        <svg width="13" height="9" viewBox="0 0 13 9" fill="none">
                            <path d="M12.5 4.74973L7.5 8.75L7.5 0.75L12.5 4.74973Z" fill="#D5333E"></path>
                            <path d="M10 4.75H0" stroke="#D5333E"></path>
                        </svg>
                    </div>
                    <p class="footer-description">Organise learning sessions with us</p>
                </div>
                <div class="footer-container-four">
                    <div class="footer-header">
                        <h2 class="footer-heading">Tech for Hire</h2>
                        <svg width="13" height="9" viewBox="0 0 13 9" fill="none">
                            <path d="M12.5 4.74973L7.5 8.75L7.5 0.75L12.5 4.74973Z" fill="#D5333E"></path>
                            <path d="M10 4.75H0" stroke="#D5333E"></path>
                        </svg>
                    </div>
                    <p class="footer-description">Hire experienced tech talents</p>
                </div>
            </div> -->
